...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_all(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,                           TD(TD_WIN),
  ...
  [1] = LAYOUT_all(
    ...
    _______,          _______,          KC_MPLY, _______,          KC_MPLY,          MO(2),                              KC_MPRV, KC_VOLD, KC_MNXT 
  ),
  ...
  [2] = LAYOUT_all(
    ...
    _______, _______, KC_WAKE, _______, RESET,   _______, _______, _______, _______, _______, _______, _______, _______,  _______,                _______,
    _______, _______, KC_SLEP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                            _______,
    _______, _______, _______, _______, _______, _______, _______, TO(3),   _______, _______, _______, _______,                    _______, 
  ...
  [3] = LAYOUT_all(
    ...
    _______, _______, _______, KC_BTN1, KC_BTN2, _______, _______, TO(0),   _______, _______, _______, _______,                    KC_WH_U, 
